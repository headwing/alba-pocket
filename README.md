...
| stomp, sockjs | Spirng과 협업을 위한 Stomp선택과, IE와 모바일 크롭 브라우저들에서의 동작을 위해 sockJs를 선택 |
| moment | javascript 내장 date메서드가 정상작동하지 않는 safari와 같은 브라우저에서의 크로스 브라우징을 위해 선택 |
...
<a href="https://github.com/team3-realproject/frontend/wiki/1:1%EC%B1%84%ED%8C%85%EC%8B%9C-%ED%83%80%EC%9D%B4%ED%95%91%EB%A7%88%EB%8B%A4-%EB%A6%AC%EB%A0%8C%EB%8D%94%EB%A7%81">📌 1:1채팅 리렌더링 </a><br>
<a href="https://github.com/team3-realproject/frontend/wiki/d-day%EA%B8%B0%EB%8A%A5-%ED%81%AC%EB%A1%9C%EC%8A%A4%EB%B8%8C%EB%9D%BC%EC%9A%B0%EC%A7%95-%EB%AC%B8%EC%A0%9C">📌 d-day로직 크로스브라우징 </a>
## 🌱 페이지별 기능 구현
| 페이지 | 기능 |
| ----- | ----- |
